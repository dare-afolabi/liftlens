...
def revenue_test() -> ExperimentConfig:
    ...
    return ExperimentConfig(
        ...
        data=DataSource(
            type="csv", path=__import__("pathlib").Path("revenue_data.csv")
        ),
        ...
        metrics=[
            ...
            MetricSpec(
                ...
                type="primary",
                func="ratio_metric",
                params={"denominator_col": "active_users"},
            ),
        ],
        transform=TransformConfig(
            winsorize=(0.01, 0.01), cuped=True, log_transform=True
        ),
    )
...
def engagement_suite() -> ExperimentConfig:
    ...
    return ExperimentConfig(
        ...
        data=DataSource(
            type="parquet", path=__import__("pathlib").Path("engagement.parquet")
        ),
        ...
        metrics=[
            ...
            MetricSpec(
                ...
                type="composite",
                func="weighted_index",
                params={"submetrics": ["sessions", "duration"]},
            ),
        ],
    )
